...
public class ReportBugsHelper {
    ...
    public static void prepareReportBugs(@NonNull Context context) {
        new MaterialDialog.Builder(context)
                ...
                .title(R.string.report_bugs_desc)
                .input(R.string.report_bugs_desc_hint, 0, false, (dialog, input) -> {})
                ...
                .inputRange(1, 200)
                .widgetColor(ColorHelper.getAttributeColor(context, R.attr.cb_colorAccent))
