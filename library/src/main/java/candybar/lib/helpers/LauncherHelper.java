...
public class LauncherHelper {
        ...
        switch (launcher) {
            ...
            case CMTHEME:
                try {
                    ...
                    new MaterialDialog.Builder(context)
                            ...
                            .title(launcherName)
                            .content(R.string.apply_cmtheme_not_available)
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    ...
                    try {
                        ...
                        intent.setComponent(new ComponentName("com.lge.launcher2",
                                "com.lge.launcher2.homesettings.HomeSettingsActivity"));
                        context.startActivity(intent);
                    } catch (ActivityNotFoundException e) {
                        Toast.makeText(context, R.string.apply_lg_home_not_available,
                                Toast.LENGTH_LONG).show();
                    } catch (SecurityException e) {
                        Toast.makeText(context, R.string.apply_lg_home_failed,
                                Toast.LENGTH_LONG).show();
                    }
                }
                break;
            ...
            case PROJECTIVY:
                try {
                    ...
                    projectivy.putExtra("packageName", context.getPackageName());
    ...
    private static void showLauncherDialog(Context context, String title, String content) {
        new MaterialDialog.Builder(context)
                .typeface(TypefaceHelper.getMedium(context), TypefaceHelper.getRegular(context))
                .title(title)
                .content(content)
    ...
    private static void showLauncherInstallDialog(Context context, String title, String content) {
        new MaterialDialog.Builder(context)
                .typeface(TypefaceHelper.getMedium(context), TypefaceHelper.getRegular(context))
                .title(title)
                .content(content)
    ...
    private static void showLauncherIncompatibleDialog(Context context, String launcherName) {
        new MaterialDialog.Builder(context)
                .typeface(TypefaceHelper.getMedium(context), TypefaceHelper.getRegular(context))
                .title(launcherName)
                .content(String.format(context.getResources().getString(
